...
<p></p>
If you are wanting to learn some basic vocabulary and phrases straight away, click <li class="nav-item">
    <button type="button" class= "btn btn-light" name="button" style="float: right;"><a href="#top">Top</a></button> to direct you to the selection of different pages.
